...
print(df.head())
print("1. What is the average pace across all laps?")
...
print("2. Which lap had the highest cadence?")
...
print("3. How many laps had a pace faster than 5:15?")
...
# print("4. Show only laps where Total Ascent > 0")
# print("5. Sort laps by Avg Pace (slowest to fastest)")
# print("6. Find laps where you slowed down compared to the previous lap")
